/*
 * Phonics Screening practice word bank.
 *
 * Source: Twinkl "Phonics Screening Practice List" sheets
 *   (Real Words + Nonsense Alien Words), transcribed from the printed
 *   sheets. Grouped into practice sets.
 *
 * Each entry:
 ...
 *   graphemes - the word split into sounds for the "拆音 / Sound it out"
 *               feature. IMPORTANT: the graphemes always join back to the
 *               exact spelling, so the card never mis-renders the word.
 *               Only true side-by-side digraphs are grouped (sh, ch, ee,
 *               oo, igh, ai, ng…); split vowels like a–e in "skate" are
 *               left as separate letters so the spelling stays correct.
 *
 * TO ADD MORE: append objects below; the app picks up every entry and
 * shuffles across all of them.
 */
...
const WORD_BANK = [
  ...
  { word: "oyster",    type: "real",  set: "練習 1", graphemes: ["oy","s","t","e","r"] },
  { word: "straw",     type: "real",  set: "練習 1", graphemes: ["s","t","r","aw"] },
  { word: "burger",    type: "real",  set: "練習 1", graphemes: ["b","ur","g","e","r"] },
  ...
  { word: "whunkey",   type: "alien", set: "練習 1", graphemes: ["wh","u","n","k","ey"] },
  { word: "femb",      type: "alien", set: "練習 1", graphemes: ["f","e","m","b"] },
  { word: "prinker",   type: "alien", set: "練習 1", graphemes: ["p","r","i","n","k","e","r"] },
  { word: "spirl",     type: "alien", set: "練習 1", graphemes: ["s","p","ir","l"] },
  { word: "thunk",     type: "alien", set: "練習 1", graphemes: ["th","u","n","k"] },
  ...
  { word: "mixer",     type: "real",  set: "練習 2", graphemes: ["m","i","x","e","r"] },
  ...
  { word: "fuel",      type: "real",  set: "練習 2", graphemes: ["f","u","e","l"] },
  { word: "drank",     type: "real",  set: "練習 2", graphemes: ["d","r","a","n","k"] },
  ...
  { word: "frue",      type: "alien", set: "練習 2", graphemes: ["f","r","u","e"] },

  // ============ 練習 3 — Real Words ============
  { word: "chill",     type: "real",  set: "練習 3", graphemes: ["ch","i","ll"] },
  { word: "blank",     type: "real",  set: "練習 3", graphemes: ["b","l","a","n","k"] },
